...
public class RealmProxyClassGenerator {
    ...
    private void emitClassFields(JavaWriter writer) throws IOException {
        ...
        for (VariableElement variableElement : metadata.getFields()) {
            if (Utils.isRealmInteger(variableElement)) {
                writer.emitField(
                        "RealmInteger",
                        variableElement.getSimpleName().toString() + "RealmInteger",
                        EnumSet.of(Modifier.PRIVATE),
                        "RealmInteger.managedRealmInteger(null, -1)");
            }
    ...
    //@formatter:off
    private void emitRealmInteger(JavaWriter writer, VariableElement field, String fieldBaseName, String fieldTypeCanonicalName) throws IOException {
        ...
        writer.emitAnnotation("Override");
        writer.beginMethod("void", metadata.getInternalSetter(fieldBaseName), EnumSet.of(Modifier.PUBLIC), fieldTypeCanonicalName, "value")
                .endMethod();
    }
    //@formatter:on
    ...
    //@formatter:off
    // FIXME: Intitialize RealmIntegers
    ...
    // FIXME: initialize RealmInteger values
    ...
    // FIXME: Intitalize the RealmInteger
